import { identity, applyMatrix, applyGivensLeft, reorthogonalize, orthogonalityError, subVector } from './Givens.js';
/**
 * n-мерная камера.
 *
 * Состояние:
...
export class Camera {
     ...
     */
    setReadablePose(angle = Math.PI / 8) {
